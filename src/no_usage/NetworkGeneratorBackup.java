...
public class NetworkGeneratorBackup {
	...
	public NetworkGeneratorBackup(double maxBandwidth, double meanBandwidth, double networkInterval, double networkSD){
		setMaxBandwidth(maxBandwidth);
	...
	public NetworkGeneratorBackup(String inputFile, double networkInterval){
		setBwTrace(new ArrayList<Double>());
		setNetworkInterval(networkInterval);
	...
	public void setMaxBandwidth(double originalBandwidth) {
		NetworkGeneratorBackup.maxBandwidth = originalBandwidth;
	}
	...
	public static void setMeanBandwidth(double meanBandwidth) {
		NetworkGeneratorBackup.meanBandwidth = meanBandwidth;
	}

	protected void setBwTrace(ArrayList<Double> bwTrace) {
		NetworkGeneratorBackup.bwTrace = bwTrace;
	}
	...
	private void setStddevPercent(double stddevPercent) {
		NetworkGeneratorBackup.stddevPercent = stddevPercent;
	}
	...
	private void setNetworkInterval(double networkInterval) {
		NetworkGeneratorBackup.networkInterval = networkInterval;
	}
}
